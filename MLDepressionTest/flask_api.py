...
class Depress:
    def Inputs(self, result):
        ...
        url = 'https://raw.githubusercontent.com/bhanuteja2001/Mental_health_Bot/master/MLDepressionTest/scaled.csv'
        df = pd.read_csv(url)
        Scaler = MinMaxScaler()
        ...
        Input = [person_age, Gender, family_history, benefits, care_options, anonymity, Leave, Work_interfere,
                 physhealthinterview, remote_work, coworkers, mentalhealthinterview, no_employees, wellness_program,
                 tech_company, seek_help, supervisor, mentalhealthconsequence, physhealthconsequence, mentalvsphysical]

        # print(Input)

        # Use pickle to load in the pre-trained model.
        with open(f'app/MLDepressionTest/Final.pkl', 'rb') as f:
